...
Find the order with the highest total product price. What is the total order price (total product price plus total shipping price to the nearest cent) for that order?
